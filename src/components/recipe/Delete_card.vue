<template>
    <div class="card">
        <div class="title">
            <h3 class="mini_title">Not sure about the post?</h3>
        </div>
        ...
        <div>
            ...
            <div class="dropdown-content">
              <h5 style="margin-top: 20px;">Are you sure?</h5>
              <p style="color: silver;">You might lose this post forever (for a long time)</p>
              ...
              <hr>
              <a href="/recipes/all" @click="deletePost"><i class="fa-solid fa-trash"  style="margin-right: 20px"></i>yes</a>
            </div>
...
export default {
    ...
    methods:{
        deletePost(){
            ...
            db.collection("Food recipies").doc("Food list").collection("food").doc(`${this.recipeID}`).delete();
        }
    },
...
button:focus ~.dropdown-content {
  opacity: 100%;
  transform: translateX(70px) translateY(21px);
}
</style>